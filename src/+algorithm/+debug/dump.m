function dump(data)
    ...
    algorithm.debug.plotInfo(...
        {
            {data.debug.sampleErrors, 'mean sqared errors for training sample'},
    ...
    algorithm.debug.plotInfo(...
        {
            {data.debug.sampleBest, 'best mean sqared error for training sample'},
    ...
    algorithm.debug.plotInfo(...
        {
            {data.debug.sampleStd, 'std of mean sqared errors for training sample'},
