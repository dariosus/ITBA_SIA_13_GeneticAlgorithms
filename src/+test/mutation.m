function [runs start params tests] = mutation()
    ...
    tests = {
        ...
        struct('name', 'locus(pM=.001;c=1)', 'mutation', @algorithm.ga.mutation.locus, 'pMutate', 0.01, 'c', 1), ...
        struct('name', 'locus(pM=.0001;c=1)', 'mutation', @algorithm.ga.mutation.locus, 'pMutate', 0.001, 'c', 1), ...
        struct('name', 'locus(pM=.001;c=.95)', 'mutation', @algorithm.ga.mutation.locus, 'pMutate', 0.01, 'c', 0.95), ...
        struct('name', 'locus(pM=.0001;c=.95)', 'mutation', @algorithm.ga.mutation.locus, 'pMutate', 0.001, 'c', 0.95) ...
    };
end
