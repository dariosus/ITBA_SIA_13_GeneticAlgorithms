function [runs start params tests] = selection2()
    ...
    tests = {
        ...
        struct('name', 'borrame'     , 'selection2', @algorithm.ga.selection.boltzmann),
        struct('name', 'borrame'     , 'selection2', @algorithm.ga.selection.boltzmann),
        struct('name', 'boltzmann'   , 'selection2', @algorithm.ga.selection.boltzmann),
