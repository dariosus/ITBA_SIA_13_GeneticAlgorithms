function [runs start params tests] = selection()
    ...
    tests = {
        ...
        struct('name', 'boltzmann(f=0.5)', 'selection', @algorithm.ga.selection.boltzmann, 'tempFactor', 0.5),
        struct('name', 'boltzmann(f=0.1)', 'selection', @algorithm.ga.selection.boltzmann, 'tempFactor', 0.1),
        struct('name', 'universal'       , 'selection', @algorithm.ga.selection.universal),
        struct('name', 'mixed1(a = 0.1)' , 'selection', @algorithm.ga.selection.mixed1, 'a', 0.1),
        struct('name', 'mixed1(a = 0.2)' , 'selection', @algorithm.ga.selection.mixed1, 'a', 0.2),
        struct('name', 'mixed2(a = 0.1)' , 'selection', @algorithm.ga.selection.mixed2, 'a', 0.1),
        struct('name', 'mixed2(a = 0.2)' , 'selection', @algorithm.ga.selection.mixed2, 'a', 0.2)
    };
end
