...
i=410;for j=1:R; i=i+1;params=struct('path', strcat('output',num2str(i),'/'), 'selection', @algorithm.ga.selection.roulette, 'selection2', @algorithm.ga.selection.elite, 'replacement', @algorithm.ga.replacement.third, 'G', 1.2);algorithm.ga.main(params);end
